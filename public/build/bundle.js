...
var app = (function () {
    ...
    function renderControlClasses(control) {
        return control.styles.map(styleToCssClass).join(' ');
    }

    /* src/Paragraph.svelte generated by Svelte v3.35.0 */
    ...
    /* src/Control.svelte generated by Svelte v3.35.0 */
    const file$2 = "src/Control.svelte";

    function create_fragment$2(ctx) {
    	let p;
    	let p_class_value;
    	let p_aria_selected_value;
    	let mounted;
    	let dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", p_class_value = renderControlClasses(/*control*/ ctx[0]));
    			attr_dev(p, "aria-selected", p_aria_selected_value = /*control*/ ctx[0].selected);
    			if (/*control*/ ctx[0].text === void 0) add_render_callback(() => /*p_input_handler*/ ctx[5].call(p));
    			add_location(p, file$2, 40, 0, 1093);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (/*control*/ ctx[0].text !== void 0) {
    				p.textContent = /*control*/ ctx[0].text;
    			}

    			if (!mounted) {
    				dispose = [
    					listen_dev(p, "focus", /*selectControl*/ ctx[2], false, false, false),
    					listen_dev(p, "keydown", /*handleKeyDown*/ ctx[3], false, false, false),
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*control*/ 1 && p_class_value !== (p_class_value = renderControlClasses(/*control*/ ctx[0]))) {
    				attr_dev(p, "class", p_class_value);
    			}

    			if (dirty & /*control*/ 1 && p_aria_selected_value !== (p_aria_selected_value = /*control*/ ctx[0].selected)) {
    				attr_dev(p, "aria-selected", p_aria_selected_value);
    			}

    			if (dirty & /*control*/ 1 && /*control*/ ctx[0].text !== p.textContent) {
    				p.textContent = /*control*/ ctx[0].text;
    			}
    		},
    		i: noop,
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function selectControl() {
    		dispatch("controlSelected", { id: control.id });
    	}
    	...
    	function p_binding($$value) {
    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			...
    			$$invalidate(1, controlElement);
    		});
    	}

    	function p_input_handler() {
    		control.text = this.textContent;
    	...
    	$$self.$inject_state = $$props => {
    		if ("control" in $$props) $$invalidate(0, control = $$props.control);
    		if ("controlElement" in $$props) $$invalidate(1, controlElement = $$props.controlElement);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*control, controlElement*/ 3) {
    			{
    ...
    class Control extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { control: 0 });
    ...
    /* src/RichTextEditor.svelte generated by Svelte v3.35.0 */
    const file$1 = "src/RichTextEditor.svelte";
    ...
    // (66:2) {#each controls as control}
    function create_each_block(ctx) {
    	let control;
    	let current;

    	control = new Control({
    			props: { control: /*control*/ ctx[8] },
    			$$inline: true
    		});

    	control.$on("controlSelected", /*handleControlSelected*/ ctx[3]);
    	control.$on("finishEditing", /*handleFinishEditing*/ ctx[4]);
    	control.$on("removeControl", /*handleRemoveControl*/ ctx[5]);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*controls*/ 1) control_changes.control = /*control*/ ctx[8];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(66:2) {#each controls as control}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$1, 60, 2, 1671);
    			add_location(button1, file$1, 61, 2, 1717);
    			attr_dev(section0, "id", "controls");
    			attr_dev(section0, "class", "svelte-2lj70z");
    			add_location(section0, file$1, 59, 1, 1645);
    			attr_dev(section1, "id", "text-editor");
    			add_location(section1, file$1, 64, 1, 1780);
    			attr_dev(main, "class", "svelte-2lj70z");
    			add_location(main, file$1, 58, 0, 1637);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*handleBold*/ ctx[1], false, false, false),
    					listen_dev(button1, "click", /*handleItalic*/ ctx[2], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*controls, handleControlSelected, handleFinishEditing, handleRemoveControl*/ 57) {
    ...
    function toggleStyle(control, style) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function handleFinishEditing(event) {
    		const newControl = {
    			id: v4(),
    			tag: Tag.Paragraph,
    			text: "",
    		...
    		$$invalidate(0, controls = [...controls, newControl]);
    		selectById(newControl.id);
    	}

    	function handleRemoveControl(event) {
    		if (controls.length === 1) return;
    		$$invalidate(0, controls = controls.filter(c => c.id !== event.detail.id));
    		const lastControl = controls[controls.length - 1];
    		selectById(lastControl.id);
    	}

    	function selectById(id) {
    		$$invalidate(0, controls = controls.map(c => {
    			c.selected = c.id === id;
    			return c;
    		}));
    	}
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<RichTextEditor> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let richtexteditor;
    	let current;
    	richtexteditor = new RichTextEditor({ $$inline: true });
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ RichTextEditor });
    	return [];
    }
